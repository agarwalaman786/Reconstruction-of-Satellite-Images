...
def data_gen_small(data_dir, mask_dir, images, batch_size, dims):
        ...
        while True:
            ...
            for i in ix:
                # images
                original_img = Image.open(data_dir + images[i]).convert('RGB')
                resized_img = original_img.resize(dims, PIL.Image.ANTIALIAS)
                ...
                original_mask = Image.open(mask_dir + img_name_parts[0] + '_3GT.png').convert('RGB')
                resized_mask = original_mask.resize(dims, PIL.Image.ANTIALIAS)
