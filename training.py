...
train_gen = data_gen_small(data_dir, mask_dir, train_images, 2, [256, 256])
val_gen = data_gen_small(data_dir, mask_dir, validation_images, 50, [256, 256])
